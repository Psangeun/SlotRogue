...
namespace SlotRogue.UI.GameFlow
{
    public sealed class SlotMachineFrameView : MonoBehaviour
    {
        ...
        private const float FallbackReelFrameHeight = 145f;
        ...
        public void PlaySpin()
        {
            ...
            if (!isActiveAndEnabled || !UsesSplitReelFrames())
            {
                return;
            }
        ...
        private void EnsureSplitReelFrames()
        {
            ...
            // The root RectTransform is authored in the prefab. Keep its anchors and offsets intact.
            _reelFrameRoot = root;
